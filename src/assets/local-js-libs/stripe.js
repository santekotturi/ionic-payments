/*! stripe-js 09-06-2017 */
(function () {
  var a, b, c, d, e, f, g, h, i, j, k, l, m, n = {}.hasOwnProperty,
    o = function (a, b) {
      function c() {
        this.constructor = a
      }
  ...
  if (k = "https://js.stripe.com", f = "https://js.stripe.com", g = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), e = "console" in window && "warn" in window.console, d = function () {
      var a;
      return (null != (a = window.performance) && "function" == typeof a.now ? a.now() : void 0) || ("function" == typeof Date.now ? Date.now() : void 0) || +new Date
    }, j = d(), !g && "querySelectorAll" in document && e && (i = document.querySelectorAll('script[src^="' + k + '"]'), i.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")), a = function () {
      function a() {
      ...
      return a.version = 2, a.endpoint = "https://api.stripe.com/v1", a.StripeV3 = null, a.setPublishableKey = function (b) {
        ...
        return d
      }, a.trackPerf = !1, a._isChannel = "#__stripe_transport__" === ("undefined" != typeof window && null !== window ? window.location.hash : void 0), a._isSafeStripeDomain = g, a._iframeOnAmount = 1, a._isSafeDomain = function () {
      ...
      }, a._iframeBaseUrl = f, a._stripejsBaseUrl = k, a._relayResponse = function (b, c, d) {
    ...
    if (3 !== this.Stripe.version) return !e || this.Stripe.isDoubleLoaded || this.Stripe.earlyError || console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page."), void(this.Stripe.isDoubleLoaded = !0);
  ...
  for (this.Stripe = a, this.Stripe.token = function () {
      ...
      return o(c, b), c.tokenName = "card", c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], c.createToken = function (b, e, f) {
        var g, h;
        ...
        if (e[c.tokenName] = a.token.formatData(b, c.whitelistedAttrs), e.time_on_page = Math.round(d() - j), null == e.guid && (e.guid = "EMPTY"), null == e.muid && (e.muid = "EMPTY"), null == e.sid && (e.sid = "EMPTY"), true) try {
          "EMPTY" === e.guid && (e.guid = a.utils.getStripeID()), "EMPTY" === e.muid && (e.muid = a.utils.getMerchantID()), "EMPTY" === e.sid && (e.sid = a.utils.getSessionID())
        } catch (i) {
          h = i, a.reportError("DeviceIdError-Extraction")
        }
      ...
      return o(c, b), c.tokenName = "bank_account", c.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type", "account_holder_name"], c.createToken = function (b, d, e) {
      ...
      return o(c, b), c.tokenName = "pii", c.whitelistedAttrs = ["personal_id_number"], c.createToken = function (b, d, e) {
      ...
      return o(c, b), c._whitelistedAttrs = ["amount", "currency", "email", "description"], c.createReceiver = function (b, c) {
        var d;
      ...
      return o(c, b), c.stripeAccount = null, c.create = function (b, c) {
        var d, e;
    ...
    }(), c = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"], l = 0, m = c.length; l < m; l++) h = c[l], this.Stripe[h] = this.Stripe.card[h];
  if (this.Stripe.stripejs_ua = "stripe.js/3539df7", !this.Stripe._isChannel && true) try {
    ...
    }, !1), "function" == typeof window.addEventListener && window.addEventListener("load", function () {
      var b, c, d, e, f, h, i;
      try {
        if (null != a.StripeV3 || a.isDoubleLoaded) return;
        c = {
        ...
        for (f in c) i = c[f], d += "" + f + "=" + encodeURIComponent(i) + "&";
        return e = document.createElement("iframe"), e.src = "https://js.stripe.com/v2/m/outer.html" + d, e.style.cssText = "width: 1px !important; height: 1px !important;\nposition: fixed !important; visibility: hidden !important;\npointer-events: none !important", e.setAttribute("frameborder", "0"), e.setAttribute("allowTransparency", "true"), e.setAttribute("scrolling", "no"), e.setAttribute("tabIndex", "-1"), e.setAttribute("aria-hidden", "true"), document.body.appendChild(e), h = window.location.href, setInterval(function () {
          var b, c, d;
          if (b = window.location.href, b !== h) {
            try {
              d = JSON.stringify({
                action: "ping",
                sid: a.utils.getSessionID(),
        ...
        return b = j, a.reportError("FailedMFrameLoad")
      }
    })
  } catch (p) {
    b = p
